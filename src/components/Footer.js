  ...
  return (
    <footer className="bg-black text-white p-8 text-center">
      ...
      <div className="mt-4 flex justify-center space-x-4">
        <a href="#privacy" className="hover:text-red-500">Privacy and Policy</a>
        <a href="#terms" className="hover:text-red-500">Terms & Conditions</a>
      </div>
      <div className="mt-4">
        <a href="mailto:info@sakaifitness.com" className="hover:text-red-500">info@sakaifitness.com</a>
      </div>
